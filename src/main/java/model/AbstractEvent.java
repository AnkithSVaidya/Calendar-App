...
public abstract class AbstractEvent {
  ...
  public boolean conflictsWith(AbstractEvent other) {
    ...
    LocalDateTime end1 = this.getEnd() != null
        ?
        this.getEnd() : thisStart.plusDays(1).withHour(0).withMinute(0).withSecond(0);
    LocalDateTime end2 = other.getEnd() != null
        ?
        other.getEnd() : otherStart.plusDays(1).withHour(0).withMinute(0).withSecond(0);
